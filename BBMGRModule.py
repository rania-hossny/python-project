...
def fun6():
    ...
    l=Label(window,text="BLOODBANK MGR",bg="red2",fg="white",font=("nunito",44,"bold"))
    l.place(x=500,y=10)
    ...
    l3=Label(window,text="E-MAIL",bg="white",fg="red2",font=("nunito",18,"bold","italic"))
    l3.place(x=30,y=360)
